...
export const BASE_URL = 'http://192.168.43.220:8000/api/';
...
export const API_ROUTES = {
  ...
  VIRTUAL_PATIENT: {
    EXPERT: {
      ...
      PROFILE: (id: string) =>
        `${BASE_URL}virtual-patient/doctor-expert/${id}/`,
    },
    LEARNER: {
      BASE: `${BASE_URL}virtual-patient/doctor-apprenant/`,
      PROFILE: (id: string) =>
        `${BASE_URL}virtual-patient/doctor-apprenant/${id}/`,
    },
    CLINICAL_CASE: {
  ...
  TUTOR: {
    ...
    ANAMESE: `${BASE_URL}tutor-module/anamese/`,
  },
  LEARNER: {
