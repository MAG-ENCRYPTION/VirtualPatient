...
export const Dashboard = ({ children }: { children: ReactNode }) => {
  ...
  return (
    <ProtectedRoutes authorization='ADMIN'>
...
const DrawerItems = [
  { text: 'Logs', icon: <LibraryBooks />, link: ROUTES.ADMIN.DASHBOARD },
  { text: 'Experts', icon: <Group />, link: ROUTES.ADMIN.EXPERTS },
  { text: 'My Profile', icon: <Person />, link: ROUTES.ADMIN.PROFILE },
