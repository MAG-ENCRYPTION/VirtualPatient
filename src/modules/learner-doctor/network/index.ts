...
export const discussion = (
  ...
  return customFetch.post(API_ROUTES.TUTOR.ANAMESE, {
    clinicalCaseId: id,
    question,
  })
}
...
export const AnameseQuestion = (Promptmessage:string):Promise<Question> => {
  return customFetch.get(API_ROUTES.TUTOR.ANAMESE)}
